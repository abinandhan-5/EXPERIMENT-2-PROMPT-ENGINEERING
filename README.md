...
4)For each scenario, design two types of prompts: a. Unstructured prompt (broad, vague, open-ended) b. Structured prompt (clear, specific, refined)
...
https://github.com/user-attachments/files/22027130/Prompt_Response_Comparison_Report.pdf
